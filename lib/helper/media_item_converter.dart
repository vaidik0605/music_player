...
class MediaItemConverter {
  ...
  static MediaItem songModelToMediaItem(SongModel songModel,String tempDirPath){
    ...
    playArtist == '<unknown>'
        ? playArtist = 'Unknown'
        : playArtist = songModel.artist!;

    final String playAlbum = songModel.album!;
    final int playDuration = songModel.duration ?? 180000;
    final String imagePath = '$tempDirPath/${songModel.displayNameWOExt}.jpg';
